...
namespace CQRS.Web.Controllers
{
    public class ActionTypeController : Controller
    {
        ...
        public ActionTypeController(IQueryDispatcher queryDispatcher, ICommandDispatcher commandDispatcher)
        {
        ...
        {
            var result = _queryDispatcher.Dispatch<EmptyQuery, ActionTypesAllQueryResult>(query);
